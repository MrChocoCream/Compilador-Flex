...
void add_error_message(const char* message);  // Declaración de la función

void yyerror(const char *s) {  // Cambié a const char *
...
char* buscar_valor(char* identificador) {
    ...
    // Devuelve NULL si el identificador no se encuentra en la tabla de símbolos
    return NULL;
}
...
void add_error_message(const char* message) {  // Cambié a const char*
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TIPO_DE_DATO = 5,               /* TIPO_DE_DATO  */
  YYSYMBOL_COMPARACION = 6,                /* COMPARACION  */
  YYSYMBOL_PALABRA_RESERVADA = 7,          /* PALABRA_RESERVADA  */
  YYSYMBOL_IDENTIFICADOR = 8,              /* IDENTIFICADOR  */
  YYSYMBOL_CONST_CADENA = 9,               /* CONST_CADENA  */
  YYSYMBOL_SIMBOLO_ASIGNACION = 10,        /* SIMBOLO_ASIGNACION  */
  YYSYMBOL_SIGNO_NEGATIVO = 11,            /* SIGNO_NEGATIVO  */
  YYSYMBOL_INCREMENTO = 12,                /* INCREMENTO  */
  YYSYMBOL_FIN = 13,                       /* FIN  */
  YYSYMBOL_IMPRIMIR_VAR = 14,              /* IMPRIMIR_VAR  */
  YYSYMBOL_15_ = 15,                       /* '+'  */
  YYSYMBOL_16_ = 16,                       /* '-'  */
  YYSYMBOL_17_ = 17,                       /* '*'  */
  YYSYMBOL_18_ = 18,                       /* '/'  */
  YYSYMBOL_19_ = 19,                       /* '^'  */
  YYSYMBOL_20_if_ = 20,                    /* "if"  */
  YYSYMBOL_21_ = 21,                       /* '('  */
  YYSYMBOL_22_ = 22,                       /* ')'  */
  YYSYMBOL_23_else_ = 23,                  /* "else"  */
  YYSYMBOL_24_while_ = 24,                 /* "while"  */
  YYSYMBOL_25_do_ = 25,                    /* "do"  */
  YYSYMBOL_26_for_ = 26,                   /* "for"  */
  YYSYMBOL_27_main_ = 27,                  /* "main"  */
  YYSYMBOL_28_printf_ = 28,                /* "printf"  */
  YYSYMBOL_29_ = 29,                       /* ','  */
  YYSYMBOL_30_scanf_ = 30,                 /* "scanf"  */
  YYSYMBOL_31_ = 31,                       /* '{'  */
  YYSYMBOL_32_ = 32,                       /* '}'  */
  YYSYMBOL_YYACCEPT = 33,                  /* $accept  */
  YYSYMBOL_programa = 34,                  /* programa  */
  YYSYMBOL_sentencia = 35,                 /* sentencia  */
  YYSYMBOL_funcion = 36,                   /* funcion  */
  YYSYMBOL_instruccion = 37,               /* instruccion  */
  YYSYMBOL_imprimir = 38,                  /* imprimir  */
  YYSYMBOL_bloque = 39,                    /* bloque  */
  YYSYMBOL_comparacion = 40,               /* comparacion  */
...
static const yytype_int16 yyrline[] =
{
     ...
     303,   304,   305,   306,   307,   308,   311,   312,   313,   316,
     316,   319,   322,   325,   325,   328,   329,   330,   331,   334,
     336,   340,   344,   348,   351,   355,   358,   359,   360,   364,
     365,   366
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ERROR", "NUMERO",
  "TIPO_DE_DATO", "COMPARACION", "PALABRA_RESERVADA", "IDENTIFICADOR",
  "CONST_CADENA", "SIMBOLO_ASIGNACION", "SIGNO_NEGATIVO", "INCREMENTO",
  "FIN", "IMPRIMIR_VAR", "'+'", "'-'", "'*'", "'/'", "'^'", "\"if\"",
  "'('", "')'", "\"else\"", "\"while\"", "\"do\"", "\"for\"", "\"main\"",
  "\"printf\"", "','", "\"scanf\"", "'{'", "'}'", "$accept", "programa",
  "sentencia", "funcion", "instruccion", "imprimir", "bloque",
  "comparacion", "declaracion", "$@1", "lista_identificadores",
  "asignacion", "expresion", "termino", "factor", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 10: /* funcion: "if" '(' comparacion ')' bloque  */
#line 303 "prueba.y"
                                          { add_syntax_token("FUNCION"); }
#line 1695 "prueba.tab.c"
    break;

  case 11: /* funcion: "if" '(' comparacion ')' bloque "else" bloque  */
#line 304 "prueba.y"
                                                        { add_syntax_token("FUNCION"); }
#line 1701 "prueba.tab.c"
    break;

  case 12: /* funcion: "while" '(' comparacion ')' bloque  */
#line 305 "prueba.y"
                                             { add_syntax_token("FUNCION"); }
#line 1707 "prueba.tab.c"
    break;

  case 13: /* funcion: "do" bloque "while" '(' comparacion ')'  */
#line 306 "prueba.y"
                                                  { add_syntax_token("FUNCION"); }
#line 1713 "prueba.tab.c"
    break;

  case 14: /* funcion: "for" '(' asignacion FIN comparacion FIN INCREMENTO IDENTIFICADOR ')' bloque  */
#line 307 "prueba.y"
                                                                                         { add_syntax_token("FUNCION"); }
#line 1719 "prueba.tab.c"
    break;

  case 15: /* funcion: TIPO_DE_DATO "main" '(' ')' bloque  */
#line 308 "prueba.y"
                                             { add_syntax_token("MAIN"); }
#line 1725 "prueba.tab.c"
    break;

  case 16: /* instruccion: "printf" '(' CONST_CADENA ')'  */
#line 311 "prueba.y"
                                           { add_syntax_token("INSTRUCCION"); }
#line 1731 "prueba.tab.c"
    break;

  case 17: /* instruccion: "printf" '(' CONST_CADENA ',' imprimir ')'  */
#line 312 "prueba.y"
                                                          { add_syntax_token("INSTRUCCION"); }
#line 1737 "prueba.tab.c"
    break;

  case 18: /* instruccion: "scanf" '(' CONST_CADENA ',' IMPRIMIR_VAR ')'  */
#line 313 "prueba.y"
                                                             { add_syntax_token("INSTRUCCION"); }
#line 1743 "prueba.tab.c"
    break;

  case 21: /* bloque: '{' programa '}'  */
#line 319 "prueba.y"
                          { add_syntax_token("BLOQUE"); }
#line 1749 "prueba.tab.c"
    break;

  case 22: /* comparacion: expresion COMPARACION expresion  */
#line 322 "prueba.y"
                                             { add_syntax_token("COMPARACION"); }
#line 1755 "prueba.tab.c"
    break;

  case 23: /* $@1: %empty  */
#line 325 "prueba.y"
                           { tipo_dato_global = strdup((yyvsp[0].str)); }
#line 1761 "prueba.tab.c"
    break;

  case 25: /* lista_identificadores: IDENTIFICADOR  */
#line 328 "prueba.y"
                                     { agregar_simbolo(tipo_dato_global, (yyvsp[0].str), NULL); }
#line 1767 "prueba.tab.c"
    break;

  case 26: /* lista_identificadores: IDENTIFICADOR SIMBOLO_ASIGNACION expresion  */
#line 329 "prueba.y"
                                                                  {agregar_simbolo(tipo_dato_global, (yyvsp[-2].str),(yyvsp[0].str)); }
#line 1773 "prueba.tab.c"
    break;

  case 27: /* lista_identificadores: IDENTIFICADOR ',' lista_identificadores  */
#line 330 "prueba.y"
                                                               { agregar_simbolo(tipo_dato_global, (yyvsp[-2].str), NULL); }
#line 1779 "prueba.tab.c"
    break;

  case 28: /* lista_identificadores: IDENTIFICADOR SIMBOLO_ASIGNACION expresion ',' lista_identificadores  */
#line 331 "prueba.y"
                                                                                            { agregar_simbolo(tipo_dato_global, (yyvsp[-4].str),(yyvsp[-2].str)); }
#line 1785 "prueba.tab.c"
    break;

  case 29: /* asignacion: IDENTIFICADOR SIMBOLO_ASIGNACION expresion  */
#line 334 "prueba.y"
                                                       {   agregar_valor((yyvsp[-2].str),(yyvsp[0].str));}
#line 1791 "prueba.tab.c"
    break;

  case 30: /* expresion: expresion '+' termino  */
#line 336 "prueba.y"
                                 { char* str = malloc(30); 
                   sprintf(str, "%f", atof((yyvsp[-2].str)) + (yyvsp[0].entero)); 
                   (yyval.str) = str; 
                   add_syntax_token("SUMA"); }
#line 1800 "prueba.tab.c"
    break;

  case 31: /* expresion: expresion '-' termino  */
#line 340 "prueba.y"
                            { char* str = malloc(30); 
                   sprintf(str, "%f", atof((yyvsp[-2].str)) - (yyvsp[0].entero)); 
                   (yyval.str) = str; 
                   add_syntax_token("RESTA"); }
#line 1809 "prueba.tab.c"
    break;

  case 32: /* expresion: '-' expresion  */
#line 344 "prueba.y"
                                         { char* str = malloc(30); 
                        sprintf(str, "%f", -atof((yyvsp[0].str))); 
                        (yyval.str) = str;  
                        add_syntax_token("NEGATIVO"); }
#line 1818 "prueba.tab.c"
    break;

  case 33: /* expresion: termino  */
#line 348 "prueba.y"
              { char* str = malloc(12); 
                                   sprintf(str, "%f", (yyvsp[0].entero)); 
                                   (yyval.str) = str;  }
#line 1826 "prueba.tab.c"
    break;

  case 34: /* expresion: CONST_CADENA  */
#line 351 "prueba.y"
                   {char* str = malloc(strlen((yyvsp[0].str)) + 3); 
            sprintf(str, "'%s'", (yyvsp[0].str)); 
            (yyval.str) = str; 
            add_syntax_token("CONST_CADENA");}
#line 1835 "prueba.tab.c"
    break;

  case 35: /* expresion: ERROR  */
#line 355 "prueba.y"
            { yyerror("Error sintactico: caracter no reconocido"); YYERROR; }
#line 1841 "prueba.tab.c"
    break;

  case 36: /* termino: termino '*' factor  */
#line 358 "prueba.y"
                            { (yyval.entero) = (yyvsp[-2].entero) * (yyvsp[0].entero); add_syntax_token("MULTIPLICACION"); }
#line 1847 "prueba.tab.c"
    break;

  case 37: /* termino: termino '/' factor  */
#line 359 "prueba.y"
                             { (yyval.entero) = (yyvsp[-2].entero) / (yyvsp[0].entero); add_syntax_token("DIVISION"); }
#line 1853 "prueba.tab.c"
    break;

  case 38: /* termino: factor  */
#line 360 "prueba.y"
                 { (yyval.entero) = (yyvsp[0].entero); }
#line 1859 "prueba.tab.c"
    break;

  case 39: /* factor: NUMERO  */
#line 364 "prueba.y"
                            {(yyval.entero) = (yyvsp[0].entero); add_syntax_token("NUMERO");}
#line 1865 "prueba.tab.c"
    break;

  case 40: /* factor: IDENTIFICADOR  */
#line 365 "prueba.y"
                            {(yyval.entero) = atof(buscar_valor((yyvsp[0].str))); add_syntax_token("IDENTIFICADOR");}
#line 1871 "prueba.tab.c"
    break;

  case 41: /* factor: '(' expresion ')'  */
#line 366 "prueba.y"
                            {(yyval.entero) = atof((yyvsp[-1].str)); add_syntax_token("BLOQUE");}
#line 1877 "prueba.tab.c"
    break;


#line 1881 "prueba.tab.c"
